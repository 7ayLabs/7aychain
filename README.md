...
Substrate-based implementation of the 7ay Proof of Presence (PoP) Protocol.
...
Building `7aychain` requires a Rust toolchain (1.85+), Clang, and LLVM. You can build it on Linux, macOS, and Windows (WSL2).
